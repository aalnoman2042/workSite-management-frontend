"use client";
import { Edit, Eye, Loader2, MoreHorizontal, Trash, Check } from "lucide-react";
...
function ManagementTable<T>({
  ...
  <DropdownMenuItem
    ...
    className={(item as { approved?: boolean }).approved ? "text-yellow-600" : "text-green-600"}
  >
    <Check className="mr-2 h-4 w-4" />
    {(item as { approved?: boolean }).approved ? "Unapprove" : "Approve"}
  </DropdownMenuItem>
)}
